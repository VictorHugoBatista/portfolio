  ...
  return (
    <Monitor>
      <section className="monitor-screen-content">
        ...
        <p>Saindo da faculdade, comecei a trabalhar com a criação de sites com Wordpress na Studio Visual. Aceitei o desafio sem ter qualquer experiência com PHP ou Wordpress, mas fazer parte de uma equipe com sede de conhecimento e evolução, logo estava dominando PHP, javascript e CSS e começamos a desafiar os limites do que desenvolvimento Wordpress significa: nós descobrimos o starter theme Sage: um tema Wordpress que já unia várias features importantes que só era possível encontrar em frameworks mais modernos, como o Laravel. Pode imaginar como foi divertido aprender tudo isso e usar nos nossos projetos?</p>
        <p>É por isso que eu acredito que é impossível dar saltos consideráveis sem uma equipe crescendo junto.</p>
        ...
        <p>Conheci o Lean Kanban e passei a trabalhar sem as sprints, precisando me adaptar novamente.</p>

        <h3>Futuro</h3>
        <p>Isso nos leva ao presente e ao futuro: Atualmente me encontro estudando Java Spring, MongoDB e atualizando meu React web.</p>
